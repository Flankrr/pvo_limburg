...
"""
scrape_bd.py
Scrapes Brabants Dagblad Economie RSS feed and appends to all_articles.json (no duplicates)
...
# Configuration
FEED_URL = "https://www.bd.nl/economie/rss.xml"
FEED_NAME = "Brabants Dagblad - Economie"
OUTPUT_FILE = "../scrapedArticles/bd.json"
...
if __name__ == "__main__":
    print("=" * 60)
    print("Brabants Dagblad - Economie Scraper")
    print("=" * 60 + "\n")
